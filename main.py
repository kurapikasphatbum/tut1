...
Original file is located at
    https://colab.research.google.com/drive/1st1rfsqA6hDh1WnV9wF4a4OP7DH3zKQd
...
print("Welcome ", name +" " + surname + "(" + age +  ")"  )
...
print("It's gonna be", str(celsius) + " in Celsius")
...
if number2 != 0:
    if number1 % number2 == 0:
        ...
        print("You cannot divide the first number by the second number.")
...
if side1 + side2 > side3 and side1 + side3 > side2 and side2 + side3 > side1:
    if side1**2 + side2**2 == side3**2 or side1**2 + side3**2 == side2**2 or side2**2 + side3**2 == side1**2:
        print("It's a valid right-angled triangle.")
    else:
        print("It's a valid triangle, but not necessarily right-angled.")
else:
